...
/**
// Vehicle AI PathFollowing Component - Created when attempting to implement AI
*/
UCLASS()
class TRAFFICSIM_API UVehiclePathFollowingComponent : public UPathFollowingComponent
{
	GENERATED_BODY()
