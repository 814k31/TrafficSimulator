...
//Currently not being used with submission June 2016
//Developped by a different group member
...
float UPIDController::NextValue(FPIDData& PIDData, float Error, float DeltaTime)
{
	...
	Result = Error * PIDData.P + PIDData.Integral * PIDData.I + Derivative * PIDData.D;
